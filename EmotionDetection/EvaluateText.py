...
def evaluate(textFile, valueFile=None):
    ...
    for line in tqdm_gui(textFile,leave=False):
        lineID = line.split(',')[0]
    ...
    if valueFile:
        ...
        if MsgBox == 'yes':
            normaliseData = tkMessageBox.askquestion ('Normalise plot','Normalise plot ?')
    ...
    MsgBox = tkMessageBox.showinfo ('return','Evaluation is completed')
